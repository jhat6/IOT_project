...
def publish_disk_usage():
    for part in psutil.disk_partitions():
            ...
            topic = 'home/RaspPi/' + part.device[5:] + '_freeDiskSpace'
            ...
            # Add drive letter into the topic
            topic = 'home/RaspPi/' + part.device[5:] + '_totalDiskSpace'
...
# Set client 
clientDesktop = mqtt.Client("RaspPi")                           
...
while count >= 1:
    ...
    ret = clientDesktop.publish("home/RaspPi/percentMemUsed", str(percentMemUsed))
    print(time.asctime(), "->" , "Mem Used %: ", percentMemUsed, "\n")
    time.sleep(delay/2)
    
    cpuLoad = psutil.cpu_percent()
    ret = clientDesktop.publish("home/RaspPi/CPULoadPer", str(cpuLoad))
